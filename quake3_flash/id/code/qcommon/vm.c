...
int	QDECL VM_Call( vm_t *vm, int callnum, ... ) {
...
#ifdef FLASH
	// The AVM2 callstack do not have the same calling convention as standard x86 CPU,
	// so the VM_CallInterpreted( vm, &callnum ) won't work, we have to reformat args.
	...
	if ( vm->compiled )
	{
		// Maybe when someone will have the strength to port vm_x86.c with AVM2 opcodes...
